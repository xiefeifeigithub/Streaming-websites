...
func ListVideoInfo(uname string, from, to int) ([]*defs.VideoInfo, error)  {
    ...
    WHERE users.login_name = ? AND video_info.create_time > FROM_UNIXTIME(?) AND video_info.display_ctime <= FROM_UNIXTIME(?)
...
func ListComments(vid string, from, to int) ([]*defs.Comment, error) {
	stmtOut, err := dbConn.Prepare(`SELECT comments.id, users.login_name, comments.content FROM
